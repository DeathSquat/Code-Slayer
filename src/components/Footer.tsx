          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start space-x-3 mb-6">
                ...
                <span
                  className="font-cinzel font-bold text-2xl demon-text"
                  data-text="DEVSPHEREINDIA"
                >
                  DEVSPHEREINDIA
                </span>
              </div>
            ...
            {/* <div>
              ...
              >
                <Button
                 ...
                 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/40"
                >
                  Generate Now
                </Button>
              </a>
